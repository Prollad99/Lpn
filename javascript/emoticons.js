...
var globIdMensaje = "mensaje1";
    ...
    function MostrarAlerta(tiempo,texto1,color) {document.getElementById(globIdMensaje).innerHTML = "<div style=\"background:"+color+";font-size:13px;padding-left:5px;color:#fff;width:100%;\">"+texto1+"</div>";
